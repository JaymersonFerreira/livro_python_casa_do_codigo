class Relationship:
    ...
    Essa classe tem todas as informações que identificam um relacionamento entre tabelas. Em qual coluna ele existe"""
...
class DataTable:
    ...
    def and_references(self, name, to, on):
        """
        Cria um reference dessa tabela para uma outra tabela
        ...
        """
        relationship  = Relationship(name, to, self, on)
